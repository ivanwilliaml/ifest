...
## What V9 adds, and what it discarded after measuring

The V9 plan proposed exploiting near-duplicate articles and pair memory. **Measured first,
...
T=time.time()-RUN_T0
print("="*58)
print("V9 — compliant + learned substitution patterns")
...
with open('ifest2026_dac_v9.ipynb','w',encoding='utf-8') as f: nbf.write(nb,f)
